...
public class ClassInitialization {
    ...
    public static void main(String[] args) {
        ...
        //Does trigger initialization, because staticFinal2 is not a constant in compile time
        System.out.println(Initable.staticFinal2);

        //Does trigger initialization, because staticNonFinal is not a constant
