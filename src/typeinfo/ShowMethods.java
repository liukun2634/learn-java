...
//                    System.out.println(method.toString()); //Show original signature, like public static void typeinfo.ShowMethods.main(java.lang.String[])
                    System.out.println(p.matcher(method.toString()).replaceAll(""));
                }
                System.out.println("***** Constructor in Class" + classPath);
                for (Constructor constructor : constructors) {
//                    System.out.println(constructor.toString()); //public typeinfo.ShowMethods()
